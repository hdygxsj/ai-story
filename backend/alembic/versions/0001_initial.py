...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("supports_tool_calling", sa.Boolean(), nullable=False, server_default=sa.true()),
        sa.Column("supports_json_mode", sa.Boolean(), nullable=False, server_default=sa.true()),
