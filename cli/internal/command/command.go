...
func NewRoot(env *Env) *Command {
	...
	api := (&Command{Name: "api", Summary: "Call backend HTTP APIs."}).Add(
		...
		&Command{Name: "materials", Summary: "Materials and structured story-state HTTP API commands."},
	...
	if args[0] == "manifest" {
		manifest := map[string]any{
			...
			"examples": []string{
				...
				"ai-story api request GET /local-novel-skills",
				"ai-story api request GET /local-novel-skills/ai-story-novel-chapter-repair/SKILL.md",
				"ai-story api request GET /local-novel-skills/ai-story-novel-new-chapter/SKILL.md",
