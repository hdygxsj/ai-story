...
var Routes = []Route{
	...
	{"POST", "/novels/{novel_id}/character-attributes", "materials"},
	{"GET", "/novels/{novel_id}/character-attributes", "materials"},
	{"PATCH", "/novels/{novel_id}/character-attributes/{attribute_id}", "materials"},
	{"DELETE", "/novels/{novel_id}/character-attributes/{attribute_id}", "materials"},
	{"POST", "/novels/{novel_id}/inventory-items", "materials"},
	{"GET", "/novels/{novel_id}/inventory-items", "materials"},
	{"PATCH", "/novels/{novel_id}/inventory-items/{item_id}", "materials"},
	{"DELETE", "/novels/{novel_id}/inventory-items/{item_id}", "materials"},
	{"POST", "/novels/{novel_id}/map-locations", "materials"},
	{"GET", "/novels/{novel_id}/map-locations", "materials"},
	{"PATCH", "/novels/{novel_id}/map-locations/{location_id}", "materials"},
	{"DELETE", "/novels/{novel_id}/map-locations/{location_id}", "materials"},
	...
	{"GET", "/local-agent-skills", "local-agent"},
	{"GET", "/local-agent-skill/SKILL.md", "local-agent"},
	{"GET", "/local-scoring-skill/SKILL.md", "local-agent"},
	{"GET", "/local-novel-skills", "local-agent"},
	{"GET", "/local-novel-skills/{skill_name}/SKILL.md", "local-agent"},
